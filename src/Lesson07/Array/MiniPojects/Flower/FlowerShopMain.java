...
public class FlowerShopMain {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Her printer vi via for loop: ");
        ...
        System.out.println();
        System.out.println("Her er navnene på de forskellige typer blomster, vi tilbyder: ");

        //enhanced for loop, der søger efter farver i flowerItem i vores Flower[] array
        for (Flower f : flowerItem) {
            System.out.println(f.getName());
        }

        //print
        System.out.println();
        System.out.println("Her er alle de farver blomster, vi tilbyder: ");
